...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.formLayoutWidget.setGeometry(QtCore.QRect(110, 0, 251, 91))
        ...
        self.pushButton.clicked.connect(MainWindow.onConnect)
        QtCore.QMetaObject.connectSlotsByName(MainWindow)

    def retranslateUi(self, MainWindow):
        _translate = QtCore.QCoreApplication.translate
        MainWindow.setWindowTitle(_translate("MainWindow", "Hello, world!"))
        self.label.setText(_translate("MainWindow", "Identifiant"))
